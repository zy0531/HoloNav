...
namespace QuantumTek.QuantumTravel
{
    ...
    [AddComponentMenu("Quantum Tek/Quantum Travel/Compass Bar")]
        ...
        public class CompassBar : MonoBehaviour
        {
            ...
            private float OriginBearing = 0f;
        ...
        private void Awake()
            ...
            {
            /*change*/
                if (OriginBearing!=GPSToUnity.OriginBearing)
                {
                    OriginBearing = GPSToUnity.OriginBearing;
                }
                float CalibratedRotation = (ReferenceObject.transform.localEulerAngles.y - (360-OriginBearing)) < 0 ? (360 + (ReferenceObject.transform.localEulerAngles.y - (360 - OriginBearing))) : (ReferenceObject.transform.localEulerAngles.y - (360 - OriginBearing));
            /*change*/
